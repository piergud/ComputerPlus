...
/*
 * https://github.com/LMSDev/LSPDFR-API/blob/master/Extensions/VehicleExtension/VehicleExtension.cs#L133
 * https://github.com/LMSDev/LSPDFR-API/blob/master/Extensions/VehicleExtension/VehicleColor.cs
 */
namespace ComputerPlus.Extensions.Rage
{
    ...
    /// Vehicle extensions
    /// </summary>
    public static class VehicleColorExtension
    {
        /// <summary>
    ...
    public static class VehicleColorNameExtensions
    {
        public static String GetVehicleColorName(this Vehicle vehicle)
        {
            try
            {
                return vehicle.GetColors().PrimaryColorName;
            }
            catch
            {
                return String.Empty;
